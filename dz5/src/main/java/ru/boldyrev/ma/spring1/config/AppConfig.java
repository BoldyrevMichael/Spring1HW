package ru.boldyrev.ma.spring1.config;
...
@EnableJpaRepositories("ru.boldyrev.ma.spring1.repository")
@ComponentScan({"ru.boldyrev.ma.spring1.repository.dao","ru.boldyrev.ma.spring1.service"})
public class AppConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        factory.setPackagesToScan("ru.boldyrev.ma.spring1.entity");
        //Установка EntityManager (см. класс AbstractDao)
